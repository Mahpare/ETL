#Since transformations are based on business requirements
# make our class scalable by using OOP’s concept.\
...
class Transform:
    ...
    def apiEconomy(self):
        ...
        mongoDB_obj = LoadMongoDB(urllib.parse.quote_plus('root'), urllib.parse.quote_plus('password'), 'host', 'GDP')
        # Insert Data into MongoDB
        mongoDB_obj.insert_into_db(gdp_india, 'India_GDP')

    # Pollution Data Transformation
    def apiPollution(self):
        print("apiPollution transformation")
        ...
        # connection to mongo db
        mongoDB_obj = LoadMongoDB(urllib.parse.quote_plus('root'), urllib.parse.quote_plus('password'), 'host',
                              'Pollution_Data')
        # Insert Data into MongoDB
